...
function Inventory() {
    ...
    // -- Artículos con staleTime más largo (ej: 5 minutos) --
    const {
        data: articlesData,
    ...
    const createMutation = useMutation({
        ...
        onSuccess: (data) => {
            ...
            // Actualiza en la caché local sin refetch global
    ...
    return (
        <div className="px-4 pb-24">
            {showScrollTopButton && (
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19V6M5 12l7-7 7 7"/></svg>
                </motion.button>
            )}
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex space-x-2">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"> <path d="M2.5 2v6h6M21.5 22v-6h-6" /><path d="M22 11.5A10 10 0 0 0 3.2 7.2M2 12.5a10 10 0 0 0 18.8 4.2" /></svg>
                    </motion.button>
